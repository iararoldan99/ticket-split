  ...
  return (
    <>
      ...
      <div className="min-h-screen flex flex-col justify-between bg-white">
        ...
        >
          <div>
            <UserHeader userName={username} sectionName="Eliminar cuenta" />
            <SidebarNavigation />
          </div>
          ...
          <div className="w-full lg:w-3/4 p-8 mt-28 lg:mt-0">
            ...
            <p className="text-gray-600 mb-6 lg:w-3/4 lg:-ml-20">Por favor, ten en cuenta que esta acción es irreversible.</p>

            <div className="p-6 bg-red-100 border border-red-300 rounded-lg shadow-md mb-6 lg:w-3/4 lg:-ml-20">
