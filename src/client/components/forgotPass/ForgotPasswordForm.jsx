        ...
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center px-6 py-12">
          ...
          <div className="md:w-1/2 bg-white p-10 rounded-lg shadow-lg max-w-lg space-y-6">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
              <div>
                <label className="block text-gray-700 font-medium mb-2">Usuario o correo electrónico</label>
                <input
                  type="email"
                  value={email}
            ...
            <div className="flex justify-center mt-10 space-x-4">
              <img src={playStoreImg} alt="App Store" className="h-12 transition-transform duration-300 hover:scale-105" />
              <img src={appImg} alt="Google Play" className="h-12 transition-transform duration-300 hover:scale-105" />
            </div>
          </div>
        </div>
      </div>
