                ...
                <div className="md:w-1/2 bg-white p-8 rounded-lg shadow-lg max-w-md">
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        ...
                        <div className="flex justify-end">
                            <Link to="/olvide-contrasena" className="text-primary text-sm">¿Olvidaste tu
                                contraseña?</Link>
                        </div>
                    ...
                    <div className="text-center mt-4">
                        <p className="text-sm">¿No tenés una cuenta? <Link to="/registro"
                                                                           className="text-primary">Regístrate</Link>
                        </p>
                    </div>
