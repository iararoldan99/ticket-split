    ...
    >
      <div className="container mx-auto flex justify-between items-center px-4 md:px-0">
        ...
        <div className={`flex-col md:flex-row items-center space-x-6 hidden md:flex text-black`}>
          ...
          <Link
            to="/ver-proyectos"
            className={`${location.pathname === '/ver-proyectos' ? 'font-bold' : 'hover:text-gray-500'}`}
          >
            Proyectos
          </Link>
      ...
      {isMenuOpen && (
        ...
        >
          ...
          <Link
            to="/ver-proyectos"
            className={`${location.pathname === '/ver-proyectos' ? 'block px-4 py-2 font-bold' : 'block px-4 py-2 hover:text-gray-500'}`}
          >
            Proyectos
          </Link>
          <Link
